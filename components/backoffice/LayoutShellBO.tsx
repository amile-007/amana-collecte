...
export default function LayoutShellBO({ centreNom, centreVille, prenom, nom, children }: Props) {
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <header className="h-14 shrink-0 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="h-8 w-8 rounded-full bg-[#CC0000] flex items-center justify-center text-white text-xs font-bold shrink-0">
              {prenom?.[0]}{nom?.[0]}
            </div>
            <form action={signOut}>
              <button
